...
namespace TurnBasedStrategyFramework.Unity.Cells
{
    ...
    {
        private Vector3 _cellDimensions = new Vector3(2f, 2f, 1.73f);
        public override Vector3 CellDimensions { get { return _cellDimensions; } protected set { _cellDimensions = value; } }
        public HexGridType GridType { get; set; } = HexGridType.odd_r;
